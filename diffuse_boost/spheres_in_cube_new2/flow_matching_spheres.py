...
class RGCFMTrainer:
    ...
    def compute_loss(self, x_data: torch.Tensor, rewards: torch.Tensor, cond: torch.Tensor = None):
        ...
        x_t_clamped = _clamp_box(x_t, self.sphere_radius, self.clip_range)
...
def train_flow_model(
    ...
    for epoch in pbar:
        ...
        for x_0, cond in loader:
            ...
            u_pred = model(t_in, _clamp_box(x_t, sphere_radius, clip_max), cond=cond_in)

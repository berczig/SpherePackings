...
def eliminate_overlaps_batched(initial_centers, radius, box_size,
    ...
    data_evaluations = {}
    data_evaluations[0] = diffuse_boost.spheres_in_Rd.data_evaluation.SphereDatasetEvaluator(initial_centers, radius, box_size[0]).evaluate()
    it = 0
    ...
    for iterations in batched_iterations:
        ...
        S = diffuse_boost.spheres_in_Rd.data_evaluation.SphereDatasetEvaluator(centers, radius, box_size[0])
...
def main():
    ...
    S = diffuse_boost.spheres_in_Rd.data_evaluation.SphereDatasetEvaluator(final_centers_2d, radius_2d, box_2d[0])
    ...
    S = diffuse_boost.spheres_in_Rd.data_evaluation.SphereDatasetEvaluator(final_centers_3d, radius_3d, box_3d[0])
